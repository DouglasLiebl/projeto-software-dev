package io.github.pages.deletePopUp;


import io.github.pages.generalPopUp.Button;
 ...
 * @author RAVEN
 */
public class DeleteMessage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdOK = new io.github.pages.generalPopUp.Button();
        cmdCancel = new io.github.pages.generalPopUp.Button();
        ...
        cmdCancel.setBackground(new Color(192, 45, 45));
        cmdCancel.setForeground(new Color(255, 255, 255));
    ...
    private io.github.pages.generalPopUp.Button cmdCancel;
    private io.github.pages.generalPopUp.Button cmdOK;
